...
$to = "contato@hayashi.bsb.br";														// To Address
$toAlt = "";												// Additional Recipients
$from = "no-reply@hayashi.bsb.br";													// From Address
$fromName = "Hayashi site";											// From Name
...
$template = "Olá,<br><br>Recebemos uma mensagem do site.<br><br>{formdata}<br><br>Data: {date}<br>Remote IP: {ip}<br><br>---<br>Tenha um ótimo dia!";											// Mail Template
$autorespondSubjectPrefix = "Re:";			// Autorespond Form Subject Prefix
$autorespondSubject = "";						// Autorespond Custom Subject
$autorespondTemplate = "Olá {name},<br><br>Obrigado pela mensagem.<br><br>Nós vamos entrar em contato o mais breve possível.<br><br>Aqui está a mensagem que você nos enviou:<br><br>{formdata}<br><br>---<br>Tenha uma ótimo dia!";					// Autorespond Template
...
$smtpHost = "zimbra.nativetrail.io";											// SMTP Host
$smtpPort = "587";											// SMTP Port
$smtpSecure = "tls";										// SMTP Use SSL/TLS (empty, ssl or tls)
$smtpUsername = "envia@hayashi.bsb.br";									// SMTP Username
$smtpPassword = "111b375836c66eb10db7656afd2a43";									// SMTP Password
